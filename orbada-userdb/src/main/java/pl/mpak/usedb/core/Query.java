 ...
 * 
 * <p>
 * Spos�b post�powania z Query.next() jest taki
 * 
 * <pre>
 * while (!query.eof()) {
 *   query.next();
 ...
 * first() oznacza wywo�anie resultSet.next() wi�c nie ma potrzeby wywo�ywania
 * tej metody samodzielnie za pierwszym razem.
 * <p>
 * <b>Kiedy ju� Query nie b�dzie potrzebne nale�y go zamkn�� inaczej GC go nie
 * zwolni bo jest na li�cie otwartych kursor�w obiektu Database.</b>
 */
public class Query extends ParametrizedCommand implements Closeable, Cloneable {
  ...
  public enum FlushMode {
    /**
     * Nie pobiera� automatycznie wszystkich danych
     */
    fmNone,
    /**
     * Pobieranie danych odb�dzie si� synchronicznie, powr�t z funkcji open()
     * lub flushAll() dopiero po zako�czeniu przenoszenia danych do lokalnego
     * bufora
     */
    fmSynch,
    /**
     * Pobieranie danych odb�dzie si� asynchronicznie, powr�t z funkcji open()
     * lub flushAll() zaraz po jej wywo�aniu, getFlushing() pozwala sprawdzi�
  ...
  /**
   * Definiuje w jaki spos�b i czy wog�le maj� by� pobierane po otwarciu
   * zapytania dane i wstawiane do bufora.
   * 
   * @param flushMode
   *          Je�li != FlushMode.fmNone to automatycznie ustawiane jest
   *          cacheData na true
  ...
  /**
   * Pozwala otworzy� zapytanie i pobra� od razu wszystkie rekordy lub pobra� je
   * w tle w zale�no�ci od parametru FlushMode
   * 
   * @param sqlText
   * @throws Exception
   */
  ...
  public boolean open() throws Exception {
    ...
    try {
      ...
      // poni�ej ustrawiany jest ponownie status OPENING gdy� b��d mug� wyst�pi� w trakcie 
  ...
  /**
   * Sprawdza zapytanie i pozwala uzyska� dost�p do meta danych Nie wykonuje
  ...
  /**
   * Zwraca dat� i godzin� rozpocz�cia otwarcia zapytania
   * 
   * @return
   */
  ...
  /**
   * Pozwala uzyskac dost�p do pola o podanej nazwie Wywo�uje wyj�tek je�li pole
   * o podanej nazwie nie istnieje Aby sprawdzi� czy podane pole istnieje na
   * li�cie nale�y si� pos�u�y� getFieldList().findFieldByName();
   * 
   * @param name
   * @return
   * @throws UseDBException
  ...
  /**
   * <p>
   * Usuwa bierz�cy rekord z listy rekord�w.
   * <p>
   * Musi by� ustawiona w�a�ciwo�� cacheData inaczej nic si� nie stanie.
   * 
   * @throws UseDBException
   */
  ...
  /**
   * <p>
   * Usuwa wybrany rekord z listy rekord�w w pami�ci.
   * <p>
   * Musi by� ustawiona w�a�ciwo�� cacheData inaczej nic si� nie stanie.
   * <p>
  ...
  /**
   * <p>
   * Dodaje rekord na ko�cu listy w pami�ci.
   * <p>
   * Musi by� ustawiona w�a�ciwo�� cacheData inaczej nic si� nie stanie.
   * <p>
   * <b>Wykonanie tego polecenia nie zmienia danych w bazie danych.</b>
  ...
  /**
   * <p>
   * Aktualizuje wybrany rekord w pami�ci.
   * <p>
   * Musi by� ustawiona w�a�ciwo�� cacheData inaczej nic si� nie stanie.
   * <p>
   * <b>Wykonanie tego polecenia nie zmienia danych w bazie danych.</b>
  ...
  /**
   * Zwraca domy�ln� klas� kolumny wg typu pola z otwartego query
   * 
   * @param index
   * @return
   */
...
//          value.setString(StreamUtil.stream2String(clob.getAsciiStream()));
      ...
      case Types.DATE:
        if ((ro = resultSet.getObject(index)) == null) {
          ...
          // niekt�re jdbc zwracaj� Date, a w niej dat� i godzin� (oracle)
          try {
            value.setDate(resultSet.getTimestamp(index));
          }
          catch (Exception ex) {
            // obs�uga b��du dla tego, �e niekt�re jdbc (odbc) nie potrafi� ponownie pobra� pola
...
//
  ...
  /**
   * Je�li nie ma �adnego rekordu ta funkcja nie mo�e by� wywo�ana Przed
   * wywo�aniem tej funkcji musi by� wywo�ana funkcja first()
   *
   * @throws IOException
   * @throws SQLException
  ...
  /**
   * <p>Pozwala pobra� rekord o numerze index. Je�li nie ma go w buforze to bufor
   * zostanie uzupe�niony. Funkcji nie nale�y wywo�ywa� dla query kt�re nie s� buforowane.
   *
   * @param index
   * @return rekord lub null je�li nie ma rekordu o podanym indeksie lub je�li Query zosta�o wcze�niej zamkni�te
   * @throws IOException
   * @throws SQLException
   * @throws VariantException
   * @throws UseDBException
  ...
  /**
   * Pozwala wype�ni� bufor wszystkimi rekordami zapytania Aby wype�nianie
   * zadzia�a�o musi by� okre�lony FlushMode
   *
   * @throws SQLException
   * @throws IOException
   * @throws VariantException
  ...
  public void sortByColumn(int modelIndex, Order order) throws UseDBException {
    // je�li by�o najpierw sortowanie przez zamian� ORDER BY to sortuj wg tej zasady
   ...
   * <p>Oznacza to, �e obiekt QueryTable nie mo�e wywo�a� tableHeader.resetOrder()
   * @return
   */
  ...
  /**
   * <p>
   * Pozwala ustawi� na wyszukanym po keyField rekordzie zgodnie z warto�ci�.
   * <p>
   * Aby locate dzia�a� Query.setCacheData() musi by� ustawione na true
   * 
   * @param keyField
   * @param value
   *          Variant, nie mo�e by� null
   * @return zwraca true je�li (pierwszy) rekord zosta� znaleziony
   * @throws UseDBException
   * @throws VariantException
   * @throws SQLException
   * @throws IOException
   ...
   * @param keyField
   * @param value
   * @param caseInsensitive dzia�a jedynie gdy warto�� pola jest konwertowalna do ci�gu znak�w String
   ...
   * i zamkni�cie obiektu Statement czyli kursora.
