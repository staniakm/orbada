...
public class QueryUtil {
  ...
  /**
   * Pobiera wiersz z otwartego query i tworzy z niego w zale�no�ci od parametru 
   * columns list� wierszy w uk�adzie pionowym czyli
   * [[DATA,TITLE,FIELD_NAME,FIELD_TYPE],[DATA,TITLE,FIELD_NAME,FIELD_TYPE],[...]]
   * Query musi by� ustawione na odpowiednim wierszu
   * 
   * @param query otwarty obiekt Query
   * @param columns kolumny kt�re maj� by� umieszczone na li�cie
  ...
  /**
   * <p>Pobiera wiersz z otwartego query i tworzy z niego w zale�no�ci od parametru 
   * columns list� wierszy w uk�adzie pionowym czyli
   * [[TITLE,DATA],[TITLE,DATA],[...]]
   * <p>TITLE b�dzie do�aczone tylko w pierszej kolumnie wynikowej
   * 
   * @param query otwarty obiekt Query
   * @param columns kolumny kt�re maj� by� umieszczone na li�cie
   * @return lista Vector&lt;Vector&gt;
  ...
  /**
   * Na podstawie danych z query tworzy statyczn� list� kolumn i wierszy
   * 
   * @param query otwarte query
   * @param title czy maj� by� do listy do�aczone tytu�y kolumn
   * @return lista Vector&lt;Vector&gt;
   * @throws Exception
   */
  ...
  /**
   * <p>Na podstawie danych z query tworzy statyczn� list� kolumn i wierszy
   * 
   * @param format 
  ...
  /**
   * Tworzy list� nazw pobranych z query
   * 
   * @param query
   * @return
   */
  ...
  /**
   * <p>Funkcja pozwala pobra� dane z aktualnego rekordu Query i wstawi� je do ci�g znak�w.
   * @param format formatuj�cy ci�g znak�w, dost�p do p�l w formatowaniu odbywa si� 
