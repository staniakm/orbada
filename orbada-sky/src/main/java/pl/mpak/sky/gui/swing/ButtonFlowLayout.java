 ...
 * 
 * Layout p�ywaj�cych komponent�w, kt�re na nim le��
 * Dzia�a w ten spos�b, �e dobiera na podstawie szeroko�ci tekstu i obrazka maksymalny
 * rozmiar komponentu. Na tej podstawie wylicza maksymaln� szeroko�� komponentu
 * nadrz�dnego i jego wysoko��. Nast�pnie uk�ada je na nim.
 *
 */
