...
public class PluginManager {
  ...
  public void initializePlugins() {
    ...
    try {
      synchronized (pluginList) {
        ...
        // sprawdzamy potrzebne wtyczki i zale�no�ci
        for (int i=0; i<getCount(); i++) {
          getPlugin(i).requires(list);
        }
        // sortujemy tak aby te zale�ne znalaz�y si� na ko�cu
  ...
  /**
   * <p>Pozwala doda� us�ugodawc� poza mechanizmem �adowania automatycznego
   * @param providerClass
   */
